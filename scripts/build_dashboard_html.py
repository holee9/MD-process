...
def build_maintenance(config):
    ...
    H.append('</div>')
    H.append('<p style="font-size:.74rem;color:var(--muted);margin-top:6px">\U0001f517 링크는 GitHub 목록·로그 <b>보기(읽기)</b> 용도입니다. 이슈 <b>등록</b>은 아래 <b>이슈 등록 폼</b>에서 표준 템플릿(작성자 필수)으로 하세요.</p>')
    H.append('</div>')
