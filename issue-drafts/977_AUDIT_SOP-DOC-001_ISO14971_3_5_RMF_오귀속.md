...
## 처리 결과 (2026-07-17 드레인 스프린트)

SOP-DOC-001 §6.4 보존기한표 RMF 행 'ISO 14971 §3.5' → 'ISO 14971:2019 §4.5'로 정정 완료(v0.2→v0.3). 동일 오류 클래스(ISO 14971 §4.x 계열↔§3.x/§7.x 혼동) 전사 스윕 결과 다른 문서에서 'ISO 14971 §3.5'가 RMF 근거로 오귀속된 사례 없음 확인 (타 문서 내 '§3.5' 표기는 각 문서 자체 내부 절 번호이며 표준 조항 인용 아님 — 오탐 배제). 실운영 문서 미참고.
