...
> **마지막 갱신:** 2026-05-14 · **다음 자동 갱신:** 매일 03:18 KST
>
> 📋 **상세 현황 보기:** [`00_프로젝트관리/문서_매트릭스.md`](00_프로젝트관리/문서_매트릭스.md) (전체 문서의 모든 메타데이터)

### 한눈에 보기

![docs](https://img.shields.io/badge/문서-122-228be6?style=flat-square)
![issues_total](https://img.shields.io/badge/이슈-96-495057?style=flat-square)
...
![research](https://img.shields.io/badge/리서치로그-29-7950f2?style=flat-square)
![crosscheck](https://img.shields.io/badge/교차검증-28-15aabf?style=flat-square)

### 이슈 상태

```mermaid
pie showData
    title 이슈 96건 (2026-05-14)
    "완료 (closed)" : 53
    "진행중 (open)" : 43
```
...
xychart-beta horizontal
    ...
    y-axis "문서 수" 0 --> 30
    bar [7,12,13,8,4,8,3,3,3,2,2,29,28]
```
