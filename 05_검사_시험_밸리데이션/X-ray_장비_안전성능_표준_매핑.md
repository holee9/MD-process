...
| SW 수명주기 | IEC 62304:2006+AMD1:2015 (Edition 2 개발 중 — FDIS 단계, 발행일 미확정; 2026-09-19 기준 발행 미확인, audit #1054) | SoTA (OJEU 미등재, EN 62304:2006/A1:2015) | Recognized (부분) | 식약처 SW밸리데이션 가이드라인 |
...
진단용 방사선 발생장치 안전관리규칙(제1185호) 검사항목과 IEC/국제 표준의 영상품질 시험 프로토콜을 매핑하여, 출하 QC·정기검사·PMS 환류에 일관된 기준을 제공한다.

### 8.2 영상품질 검사 항목 매핑

| 검사 항목 | 규칙 제1185호 근거 | IEC/국제 표준 | 시험 방법·판정 기준 | 출하 QC 반영 |
|-----------|-------------------|--------------|-------------------|-------------|
...
| AEC 정확도 | 별표 — 자동노출제어 | IEC 60601-2-54 §203.6 (Table 203.102) | ±25% 이내 | 출하 교정 기록 |
| 관전압 정확도 | 제5조 | IEC 60601-2-54 §203.6 (Table 203.101) | ±10% 이내 | 출하 교정 기록 |
